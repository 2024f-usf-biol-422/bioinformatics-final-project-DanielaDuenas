...
vcf_with_metadata %>%
  ...
  ggplot(aes(x = pos,
             ...
             color = tissue)) +
  geom_point(size = 3, alpha = 0.6) +
  labs(title = "SNPs Across H. sapien Genomes of Infected Tissues",
       x = "Position on Genome",
       y = "SNP Quality",
       color = "Tissue Type") +
  theme_few()
...
vcf_with_metadata %>%
  ...
  ggplot(aes(x = pos,
             ...
             color = cell_type)) +
  geom_point(size = 3, alpha = 0.6) +
  labs(title = "SNPs Across C. aethiops Genomes of Infected Cells",
       x = "Position on Genome",
       y = "SNP Quality",
       color = "Cell Line") +
  theme_few()
...
vcf_with_metadata %>%
  ...
  ggplot(aes(x = pos,
             ...
             color = treatment)) +
  geom_point(size = 3, alpha = 0.6) +
  labs(title = "SNPs Across H. sapien Genome Based on Cell Treatment",
       x = "Position on Genome",
       y = "SNP Quality",
...
vcf_with_metadata %>%
  ...
  ggplot(aes(x = pos,
             ...
             color = cell_line)) +
  geom_point(size = 3, alpha = 0.6) +
  labs(title = "SNPs Across H. sapien Genome Per Infected Cell Line",
       x = "Position on Genome",
       y = "SNP Quality",
       color = "Cell Line") +
  theme_few()
