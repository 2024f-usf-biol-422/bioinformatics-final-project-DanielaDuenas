...
vcf_with_metadata %>%
  ...
  ggplot(aes(x = pos,
             ...
             color = tissue)) +
  geom_point(size = 3, alpha = 0.6) +
  labs(title = "SNPs Found in H. sapien Infected Tissues",
       x = "Position on Genome",
       y = "SNP Quality",
       color = "Tissue Type") +
  theme_few()
...
vcf_with_metadata %>%
  ...
  ggplot(aes(x = pos,
             ...
             color = cell_type)) +
  geom_point(size = 3, alpha = 0.6) +
  labs(title = "SNPs Found in C. aethiops Infected Cells",
       x = "Position on Genome",
       y = "SNP Quality",
       color = "Cell Line") +
  theme_few()
...
vcf_with_metadata %>%
  ...
  ggplot(aes(x = pos,
             ...
             color = cell_line)) +
  geom_point(size = 3, alpha = 0.6) +
  labs(title = "SNPs within H. sapien Infected Cell Lines",
       x = "Position on Genome",
       y = "SNP Quality",
       color = "Cell Line") +
  theme_few()
